...
require("toggleterm").setup{
  ...
  keep_after_exit = false -- don't dispose the terminal window when the process exits
...
Terminal:new {
  ...
  keep_after_exit = bool -- don't dispose the terminal window when the process exits
